...
class MarksController extends Controller
{
    ...
    public function MarksEditGetStudents(Request $request){
        ...
        $getStudent = StudentMarks::with(['student'])->where('year_id',$year_id)->where('periode_id',$request->periode_id)->where('class_id',$class_id)->where('assign_subject_id',$assign_subject_id)->where('exam_type_id',$exam_type_id)->get();
    ...
    StudentMarks::where('year_id',$request->year_id)->where('periode_id',$request->periode_id)->where('class_id',$request->class_id)->where('assign_subject_id',$request->assign_subject_id)->where('exam_type_id',$request->exam_type_id)->delete();
