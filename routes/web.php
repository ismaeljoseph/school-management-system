...
use App\Http\Controllers\Backend\Setup\StudentPeriodeController;
...
// Student Periode Routes 

Route::get('student/periode/view', [StudentPeriodeController::class, 'ViewPeriode'])->name('student.periode.view');

Route::get('student/periode/add', [StudentPeriodeController::class, 'StudentPeriodeAdd'])->name('student.periode.add');

Route::post('student/periode/store', [StudentPeriodeController::class, 'StudentPeriodeStore'])->name('store.student.periode');

Route::get('student/periode/edit/{id}', [StudentPeriodeController::class, 'StudentPeriodeEdit'])->name('student.periode.edit');

Route::post('student/periode/update/{id}', [StudentPeriodeController::class, 'StudentPeriodeUpdate'])->name('update.student.periode');

Route::get('student/periode/delete/{id}', [StudentPeriodeController::class, 'StudentPeriodeDelete'])->name('student.periode.delete');

// Periode Group Routes 
